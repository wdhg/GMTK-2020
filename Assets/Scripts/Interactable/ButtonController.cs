  ...
  private void animateClicked() {
    ...
    switch (id) {
      ...
      case "slider_0":
        ...
        if (sprite != null) {
          sprite.localPosition = new Vector3(-0.2399f, -0.259f, 0);
        }
        break;
      case "slider_1":
        sprite = GameObject.Find("Handle").GetComponent<Transform>();
        if (sprite != null) {
          sprite.localPosition = new Vector3(-0.1238f, -0.259f, 0);
        }
        break;
      case "slider_2":
        sprite = GameObject.Find("Handle").GetComponent<Transform>();
        if (sprite != null) {
          sprite.localPosition = new Vector3(-0.0105f, -0.259f, 0);
        }
        break;
      case "slider_3":
        sprite = GameObject.Find("Handle").GetComponent<Transform>();
        if (sprite != null) {
          sprite.localPosition = new Vector3(0.1056f, -0.259f, 0);
        }
        break;
      case "slider_4":
        sprite = GameObject.Find("Handle").GetComponent<Transform>();
        if (sprite != null) {
          sprite.localPosition = new Vector3(0.2217f, -0.259f, 0);
        }
        break;
      case "lever":
